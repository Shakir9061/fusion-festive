...
import 'package:flutter_application_1/admin/bookdetAdmin.dart';
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => BookDetAdmin(Time:time.text,Date:date.text),));
                  },
                  child: Container(
                    height: 50,
                    width: 100,
