...
import 'package:flutter_application_1/admin/bookingadmin.dart';
import 'package:flutter_application_1/admin/enquiryadmin.dart';
import 'package:google_fonts/google_fonts.dart';

class WorkDetAdmin extends StatefulWidget {
  const WorkDetAdmin({super.key});

  @override
  State<WorkDetAdmin> createState() => _WorkDetAdminState();
}

class _WorkDetAdminState extends State<WorkDetAdmin> {
  @override
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    onTap:() {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => EnquiryAdmin(),));
                    }, 
                    child: Container(
                      height: 40,
                      width: 100,
