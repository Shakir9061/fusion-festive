...
class BookDetAdmin extends StatefulWidget {
  var Time;
  var Date;
  BookDetAdmin({super.key, this.Time, this.Date});

  @override
  State<BookDetAdmin> createState() => _BookDetAdminState();
}

class _BookDetAdminState extends State<BookDetAdmin> {
  @override
